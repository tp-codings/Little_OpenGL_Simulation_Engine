...
{
	//Initialize Models
	this->testCube = new ModelHandler(R"(resources\models\cube\cube.obj)");
}
...
{
	this->testCube->Translate(glm::vec3(0.0, 0.0, 0.0));
	this->testCube->Rotate(glfwGetTime(), glm::vec3(0, 0, 1));
	this->testCube->Scale(1.0f);
}
...
void Simulation::DrawSimulation()
{
	...
	this->testCube->Draw(&this->cubeShader, this->projection, this->view, BLUE_GREEN);
